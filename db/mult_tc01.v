//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=7 LPM_WIDTHB=16 LPM_WIDTHP=23 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_tc01
	...
	assign
		wire_sft10a_in = {w213w, {w213w, {w213w, {w213w, {w213w, {w205w, {w213w, {w213w, {w213w, {w213w, {w213w, {w213w, {w213w, {w213w, {w213w, {w213w, w205w}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft4a_in = {w213w, {w213w, {w_lone_sum_node11w[15], {(~ w_lone_sum_node11w[14]), {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19:18]}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w213w, {w213w, {wire_sft11a_out[15], {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[37], {w_sum_node10w[36], {2{w213w}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w213w, {(~ w_sum_node10w[53]), {w_sum_node10w[52], {(~ w_sum_node10w[35]), {w205w, {(~ w_lone_sum_node11w[11]), {(~ w_lone_sum_node11w[10]), {(~ w_lone_sum_node11w[9]), {(~ w_lone_sum_node11w[8]), {(~ w_lone_sum_node11w[7]), {(~ w_lone_sum_node11w[6]), {(~ w_lone_sum_node11w[5]), {(~ w_lone_sum_node11w[4]), {(~ w_lone_sum_node11w[3]), {(~ w_lone_sum_node11w[2]), {(~ w_lone_sum_node11w[1]), (~ w_lone_sum_node11w[0])}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w213w, {w213w, {w213w, {w213w, {(~ w_lone_sum_node11w[12]), {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41], {w_sum_node10w[40], {w_sum_node10w[39:38]}}}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[15:0]},
		datab_node = {dataa[6:0]},
		final_result_node = {w369w[22:0]},
		result = {final_result_node[22:0]},
		w205w = 1'b1,
		w213w = 1'b0,
		w369w = {wire_sft6a_out[21:20], wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[15:0]} & {16{w_le_datab_node8w[6]}}), ({dataa_node[15:0]} & {16{w_le_datab_node8w[5]}}), ({dataa_node[15:0]} & {16{w_le_datab_node8w[4]}}), ({dataa_node[15:0]} & {16{w_le_datab_node8w[3]}}), ({dataa_node[15:0]} & {16{w_le_datab_node8w[2]}}), ({dataa_node[15:0]} & {16{w_le_datab_node8w[1]}}), ({dataa_node[15:0]} & {16{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[6:0]},
		w_lone_sum_node11w = {w_decoder_node9w[111:96]},
