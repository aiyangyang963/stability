//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" LPM_PIPELINE=3 LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=18 LPM_WIDTHB=18 LPM_WIDTHP=36 LPM_WIDTHS=36 MAXIMIZE_SPEED=7 clken clock dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
`endif
	...
	reg  [17:0]  datab_input_reg;
	reg  [35:0]  result_output_reg;
	reg  [35:0]  result_extra0_reg;
	...
	always @(posedge clock)
		if (clken == 1'b1)
			result_extra0_reg <= result_wire[35:0];
