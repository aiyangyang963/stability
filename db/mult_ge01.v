//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=13 LPM_WIDTHB=16 LPM_WIDTHP=29 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_ge01
	...
	wire	[13:0]	wire_add12_result;
	wire	[7:0]	wire_add17_result;
	wire	[27:0]	wire_add2_result;
	...
	wire  [13:0]   wire_sft13a_in;
	wire  [13:0]   wire_sft13a_out;
	wire  [13:0]   wire_sft14a_in;
	wire  [13:0]   wire_sft14a_out;
	wire  [13:0]   wire_sft15a_in;
	wire  [13:0]   wire_sft15a_out;
	wire  [13:0]   wire_sft16a_in;
	wire  [13:0]   wire_sft16a_out;
	...
	wire  [27:0]   wire_sft3a_in;
	wire  [27:0]   wire_sft3a_out;
	wire  [27:0]   wire_sft4a_in;
	wire  [27:0]   wire_sft4a_out;
	wire  [27:0]   wire_sft5a_in;
	wire  [27:0]   wire_sft5a_out;
	wire  [27:0]   wire_sft6a_in;
	wire  [27:0]   wire_sft6a_out;
	...
	assign
		wire_sum_adder1aa_5dataa = {w_decoder_node9w[191], w_decoder_node9w[191:176]},
		wire_sum_adder1aa_5datab = {{2{w_decoder_node9w[175]}}, w_decoder_node9w[175:161]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w364w, {w364w, {w364w, {w364w, {w364w, {(~ w_sum_node10w[71]), {w344w, {(~ w_lone_sum_node11w[9]), {(~ w_lone_sum_node11w[8]), {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[73], {w_sum_node10w[72], {2{w364w}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w364w, {w_sum_node10w[70], {(~ w_sum_node10w[53]), {w344w, {(~ w_lone_sum_node11w[7]), {(~ w_lone_sum_node11w[6]), {w_sum_node10w[97], {w_sum_node10w[96], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[91:90]}}}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w364w, {w364w, {w364w, {w_sum_node10w[68], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27:26]}}}}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w364w, {w364w, {w364w, {w364w, {(~ w_sum_node10w[35]), {w344w, {(~ w_lone_sum_node11w[5]), {(~ w_lone_sum_node11w[4]), {(~ w_lone_sum_node11w[3]), {(~ w_lone_sum_node11w[2]), {(~ w_lone_sum_node11w[1]), {(~ w_lone_sum_node11w[0]), {2{w364w}}}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft18a_in = {w364w, {w_sum_node10w[34], {w344w, {w_sum_node10w[16], {w_sum_node10w[15], {w_sum_node10w[14], {w_sum_node10w[13], w344w}}}}}}};
	soft   sft19a_0
	( 
	...
	assign
		wire_sft19a_in = {w364w, {w364w, {(~ w_sum_node10w[17]), {w364w, {w364w, {w364w, {w364w, w_sum_node10w[12]}}}}}}};
	soft   sft20a_0
	( 
	...
	assign
		wire_sft20a_in = {w364w, {w364w, {w364w, {w364w, {w364w, {w364w, {2{w364w}}}}}}}};
	soft   sft21a_0
	( 
	...
	assign
		wire_sft3a_in = {w344w, {wire_sft11a_out[22], {w344w, {w344w, {(~ w_lone_sum_node11w[13]), {w_sum_node10w[88], {w_sum_node10w[87], {w_sum_node10w[86], {w_sum_node10w[69], {w_sum_node10w[52], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w364w, {w364w, {w_lone_sum_node11w[15], {(~ w_lone_sum_node11w[14]), {w_sum_node10w[105], {w_sum_node10w[104], {wire_sft11a_out[17], {wire_sft11a_out[16], {wire_sft11a_out[15], {wire_sft11a_out[14], {wire_sft16a_out[9], {wire_sft16a_out[8], {wire_sft16a_out[7], {wire_sft16a_out[6], {wire_sft16a_out[5], {wire_sft16a_out[4], {wire_sft16a_out[3], {wire_sft16a_out[2], {wire_sft11a_out[5], {wire_sft11a_out[4], {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19:18]}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w364w, {w364w, {wire_sft11a_out[21], {wire_sft11a_out[20], {wire_sft11a_out[19], {wire_sft11a_out[18], {wire_sft16a_out[13], {wire_sft16a_out[12], {wire_sft16a_out[11], {wire_sft16a_out[10], {wire_sft21a_out[7], {wire_sft21a_out[6], {wire_sft21a_out[5], {wire_sft21a_out[4], {wire_sft21a_out[3], {wire_sft21a_out[2], {wire_sft21a_out[1], {wire_sft21a_out[0], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[37], {w_sum_node10w[36], {2{w364w}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w364w, {(~ w_sum_node10w[107]), {w_sum_node10w[106], {(~ w_sum_node10w[89]), {w344w, {(~ w_lone_sum_node11w[11]), {(~ w_lone_sum_node11w[10]), {w_sum_node10w[101], {w_sum_node10w[100], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55:54]}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		...
		w_lone_sum_node11w = {w_decoder_node9w[207:192]},
