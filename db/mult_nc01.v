//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=4 LPM_WIDTHB=16 LPM_WIDTHP=20 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_nc01
	...
	wire	[17:0]	wire_sum_adder1aa_1result_int;
	...
	assign
		wire_sum_adder1aa_1result = wire_sum_adder1aa_1result_int[17:1];
	assign
	...
	assign
		wire_sft4a_in = {w119w, {w119w, {w117w, {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19:18]}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w119w, {w119w, {w119w, {w117w, {w119w, {w119w, {w119w, {w119w, {w119w, {w119w, {w119w, {w119w, {w119w, {w119w, {w119w, {w119w, {w119w, {2{w119w}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		...
		final_result_node = {w197w[19:0]},
		result = {final_result_node[19:0]},
		w117w = 1'b1,
		w119w = 1'b0,
		w197w = {wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[15:0]} & {16{w_le_datab_node8w[3]}}), ({dataa_node[15:0]} & {16{w_le_datab_node8w[2]}}), ({dataa_node[15:0]} & {16{w_le_datab_node8w[1]}}), ({dataa_node[15:0]} & {16{w_le_datab_node8w[0]}})},
