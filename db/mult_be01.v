//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=15 LPM_WIDTHB=16 LPM_WIDTHP=31 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_be01
	...
	wire  [29:0]   wire_sft3a_in;
	wire  [29:0]   wire_sft3a_out;
	wire  [29:0]   wire_sft4a_in;
	wire  [29:0]   wire_sft4a_out;
	wire  [29:0]   wire_sft5a_in;
	wire  [29:0]   wire_sft5a_out;
	wire  [29:0]   wire_sft6a_in;
	wire  [29:0]   wire_sft6a_out;
	...
	assign
		wire_sum_adder1aa_6dataa = {w_decoder_node9w[223], w_decoder_node9w[223:208]},
		wire_sum_adder1aa_6datab = {{2{w_decoder_node9w[207]}}, w_decoder_node9w[207:193]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w409w, {w409w, {w409w, {w409w, {w409w, {(~ w_sum_node10w[89]), {w393w, {(~ w_lone_sum_node11w[9]), {(~ w_lone_sum_node11w[8]), {w_sum_node10w[117], {w_sum_node10w[116], {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[73], {w_sum_node10w[72], {2{w409w}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w409w, {w_sum_node10w[88], {(~ w_sum_node10w[71]), {w393w, {(~ w_lone_sum_node11w[7]), {(~ w_lone_sum_node11w[6]), {w_sum_node10w[115], {w_sum_node10w[114], {w_sum_node10w[97], {w_sum_node10w[96], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[91:90]}}}}}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w409w, {w409w, {w409w, {w_sum_node10w[86], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27:26]}}}}}}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w409w, {w409w, {w409w, {w409w, {(~ w_sum_node10w[53]), {w393w, {(~ w_lone_sum_node11w[5]), {(~ w_lone_sum_node11w[4]), {w_sum_node10w[113], {w_sum_node10w[112], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[109], {w_sum_node10w[108], {2{w409w}}}}}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft18a_in = {w409w, {w_sum_node10w[52], {(~ w_sum_node10w[35]), {w393w, {(~ w_lone_sum_node11w[3]), {(~ w_lone_sum_node11w[2]), {(~ w_lone_sum_node11w[1]), (~ w_lone_sum_node11w[0])}}}}}}};
	soft   sft19a_0
	( 
	...
	assign
		wire_sft19a_in = {w409w, {w409w, {w409w, {w_sum_node10w[34], {(~ w_sum_node10w[17]), {w_sum_node10w[16], {w_sum_node10w[15:14]}}}}}}};
	soft   sft20a_0
	( 
	...
	assign
		wire_sft20a_in = {w409w, {w409w, {w409w, {w409w, {w393w, {w409w, {w409w, w393w}}}}}}};
	soft   sft21a_0
	( 
	...
	assign
		wire_sft3a_in = {w393w, {wire_sft11a_out[24], {w393w, {w393w, {(~ w_lone_sum_node11w[13]), {w_sum_node10w[106], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[87], {w_sum_node10w[70], {wire_sft11a_out[15], {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w409w, {w409w, {w_lone_sum_node11w[15], {(~ w_lone_sum_node11w[14]), {w_sum_node10w[123], {w_sum_node10w[122], {wire_sft11a_out[19], {wire_sft11a_out[18], {wire_sft11a_out[17], {wire_sft11a_out[16], {wire_sft16a_out[11], {wire_sft16a_out[10], {wire_sft16a_out[9], {wire_sft16a_out[8], {wire_sft16a_out[7], {wire_sft16a_out[6], {wire_sft16a_out[5], {wire_sft16a_out[4], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19:18]}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft9a_in = {w409w, {w409w, {w409w, {w409w, {(~ w_lone_sum_node11w[12]), {w_sum_node10w[121], {w_sum_node10w[120], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41], {w_sum_node10w[40], {w_sum_node10w[39:38]}}}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[15:0]},
		datab_node = {dataa[14:0]},
		final_result_node = {w723w[30:0]},
		result = {final_result_node[30:0]},
		w393w = 1'b1,
		w409w = 1'b0,
		w723w = {wire_sft6a_out[29:28], wire_sft6a_out[27:26], wire_sft6a_out[25:24], wire_sft6a_out[23:22], wire_sft6a_out[21:20], wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		...
		w_lone_sum_node11w = {w_decoder_node9w[239:224]},
