...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/fir_2_10hz_rtl_core_u0_m0_wo0_cm0_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fir_2_10hz_rtl_core_u0_m0_wo0_wi0_r0_ra0_count1_lut_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_2_10hz_rtl_core.vhd"                        
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_2_10hz_ast.vhd"                             
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_2_10hz.vhd"                                 
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_2_10hz_tb.vhd"                              
fi
