...
% ================================================================================
% Generated on: 08/04/2017 10:01:25
...
for j = 1:sx
    ...
    %
    file_name = ['fir_2_10hz_input.txt'];
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = fir_2_10hz_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['fir_2_10hz_model_output'];
