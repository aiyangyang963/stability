...
# ----------------------------------------
# If fir_2_10hz is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.0 595 win32 2017.08.04.10:01:26
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/fir_2_10hz_rtl_core_u0_m0_wo0_cm0_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fir_2_10hz_rtl_core_u0_m0_wo0_wi0_r0_ra0_count1_lut_lutmem.hex ./
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_2_10hz_rtl_core.vhd"                        
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_2_10hz_ast.vhd"                             
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_2_10hz.vhd"                                 
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_2_10hz_tb.vhd"                              
}
