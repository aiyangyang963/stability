...
# ----------------------------------------
# If fir_2_10hz_nco is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.0 595 win32 2017.07.06.09:20:39
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fir_2_10hz_nco"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/fir_2_10hz_nco_rtl_core_u0_m0_wo0_cm0_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fir_2_10hz_nco_rtl_core_u0_m0_wo0_wi0_r0_ra0_count1_lut_lutmem.hex ./
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_2_10hz_nco_rtl_core.vhd"                    
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_2_10hz_nco_ast.vhd"                         
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_2_10hz_nco.vhd"                             
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir_2_10hz_nco_tb.vhd"                          
}
