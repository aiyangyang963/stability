...
% ================================================================================
% Generated on: 07/06/2017 09:20:38
% Generated by: FIR Compiler II 17.0
%---------------------------------------------------------------------------------------------------------
%
...
for j = 1:sx
    ...
    %
    file_name = ['fir_2_10hz_nco_input.txt'];
     ...
     % run this output through the model 
      for i =  1 : num_ch
        if(not(isempty(single_channel_data{i})))
          output_ch{i} = fir_2_10hz_nco_mlab(single_channel_data{i}, single_channel_bank{i});
  ...
  for j = 1: limit;
    ...
    file_name = ['fir_2_10hz_nco_model_output'];
