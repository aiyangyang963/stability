...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/auk_dspip_avalon_streaming_sink.vhd"       -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/auk_dspip_avalon_streaming_source.vhd"     -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/auk_dspip_avalon_streaming_controller.vhd" -work fft_ii_0
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fft_fft_ii_0.sv"                           -work fft_ii_0
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/fft.vhd"                                                            
fi
