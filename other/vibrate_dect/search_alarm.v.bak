...
parameter dat0_high_threshold =16'h0800;
parameter dat0_high_cnt =10;
parameter dat0_low_cnt  =5;

parameter dat1_high_threshold =16'h0800;
parameter dat1_high_cnt =10;
parameter dat1_low_cnt  =5;

parameter dat2_high_threshold =16'h0800;
parameter dat2_high_cnt =10;
parameter dat2_low_cnt  =5;

parameter dat3_high_threshold =16'h0800;
