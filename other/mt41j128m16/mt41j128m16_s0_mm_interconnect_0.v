// mt41j128m16_s0_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module mt41j128m16_s0_mm_interconnect_0 (
	...
	mt41j128m16_s0_mm_interconnect_0_router router (
	...
	mt41j128m16_s0_mm_interconnect_0_router_001 router_001 (
	...
	mt41j128m16_s0_mm_interconnect_0_router_002 router_002 (
	...
	mt41j128m16_s0_mm_interconnect_0_router_003 router_003 (
	...
	mt41j128m16_s0_mm_interconnect_0_router_003 router_004 (
	...
	mt41j128m16_s0_mm_interconnect_0_router_003 router_005 (
	...
	mt41j128m16_s0_mm_interconnect_0_router_006 router_006 (
	...
	mt41j128m16_s0_mm_interconnect_0_router_003 router_007 (
	...
	mt41j128m16_s0_mm_interconnect_0_router_008 router_008 (
	...
	mt41j128m16_s0_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (avl_clk_out_clk_clk),                          //        clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_cmd_demux_002 cmd_demux_002 (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_cmd_mux_003 cmd_mux_003 (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_cmd_mux_005 cmd_mux_005 (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_cmd_demux_002 rsp_demux (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_cmd_demux_002 rsp_demux_001 (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_cmd_demux_002 rsp_demux_002 (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_cmd_demux_002 rsp_demux_004 (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_rsp_demux_005 rsp_demux_005 (
		.clk                (avl_clk_out_clk_clk),                          //       clk.clk
		.reset              (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_rsp_mux_002 rsp_mux_002 (
		.clk                 (avl_clk_out_clk_clk),                          //       clk.clk
		.reset               (cpu_inst_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mt41j128m16_s0_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
