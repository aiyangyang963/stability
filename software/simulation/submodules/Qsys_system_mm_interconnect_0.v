...
module Qsys_system_mm_interconnect_0 (
	...
	wire  [92:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> nios2_qsys_0_jtag_debug_module_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                              // nios2_qsys_0_jtag_debug_module_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [6:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> nios2_qsys_0_jtag_debug_module_agent:cp_channel
	...
	wire  [92:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> onchip_ram_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // onchip_ram_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [6:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> onchip_ram_s1_agent:cp_channel
	...
	wire  [93:0] pio_led_s1_agent_rf_source_data;                                                    // pio_led_s1_agent:rf_source_data -> pio_led_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] pio_led_s1_agent_rsp_fifo_out_data;                                                 // pio_led_s1_agent_rsp_fifo:out_data -> pio_led_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pio_led_s1_agent:cp_data
	...
	wire  [16:0] pio_key_s1_agent_m0_address;                                                        // pio_key_s1_agent:m0_address -> pio_key_s1_translator:uav_address
	...
	wire  [93:0] pio_key_s1_agent_rf_source_data;                                                    // pio_key_s1_agent:rf_source_data -> pio_key_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] pio_key_s1_agent_rsp_fifo_out_data;                                                 // pio_key_s1_agent_rsp_fifo:out_data -> pio_key_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> pio_key_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // pio_key_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pio_key_s1_agent:cp_channel
	...
	wire         cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> onchip_rom_s1_agent:cp_valid
	wire  [92:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> onchip_rom_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // onchip_rom_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> onchip_rom_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> onchip_rom_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> onchip_rom_s1_agent:cp_endofpacket
	...
	wire  [92:0] nios2_qsys_0_jtag_debug_module_agent_rp_data;                                       // nios2_qsys_0_jtag_debug_module_agent:rp_data -> router_004:sink_data
	...
	wire  [92:0] onchip_ram_s1_agent_rp_data;                                                        // onchip_ram_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [92:0] pio_led_s1_agent_rp_data;                                                           // pio_led_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [92:0] pio_key_s1_agent_rp_data;                                                           // pio_key_s1_agent:rp_data -> router_007:sink_data
	...
	wire         onchip_rom_s1_agent_rp_valid;                                                       // onchip_rom_s1_agent:rp_valid -> router_008:sink_valid
	wire  [92:0] onchip_rom_s1_agent_rp_data;                                                        // onchip_rom_s1_agent:rp_data -> router_008:sink_data
	wire         onchip_rom_s1_agent_rp_ready;                                                       // router_008:sink_ready -> onchip_rom_s1_agent:rp_ready
	wire         onchip_rom_s1_agent_rp_startofpacket;                                               // onchip_rom_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         onchip_rom_s1_agent_rp_endofpacket;                                                 // onchip_rom_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire  [92:0] router_src_data;                                                                    // router:src_data -> nios2_qsys_0_data_master_limiter:cmd_sink_data
	wire         router_src_ready;                                                                   // nios2_qsys_0_data_master_limiter:cmd_sink_ready -> router:src_ready
	wire   [6:0] router_src_channel;                                                                 // router:src_channel -> nios2_qsys_0_data_master_limiter:cmd_sink_channel
	...
	wire  [92:0] nios2_qsys_0_data_master_limiter_cmd_src_data;                                      // nios2_qsys_0_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         nios2_qsys_0_data_master_limiter_cmd_src_ready;                                     // cmd_demux:sink_ready -> nios2_qsys_0_data_master_limiter:cmd_src_ready
	wire   [6:0] nios2_qsys_0_data_master_limiter_cmd_src_channel;                                   // nios2_qsys_0_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [92:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_qsys_0_data_master_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                                  // nios2_qsys_0_data_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [6:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> nios2_qsys_0_data_master_limiter:rsp_sink_channel
	...
	wire  [92:0] nios2_qsys_0_data_master_limiter_rsp_src_data;                                      // nios2_qsys_0_data_master_limiter:rsp_src_data -> nios2_qsys_0_data_master_agent:rp_data
	...
	wire   [6:0] nios2_qsys_0_data_master_limiter_rsp_src_channel;                                   // nios2_qsys_0_data_master_limiter:rsp_src_channel -> nios2_qsys_0_data_master_agent:rp_channel
	...
	wire  [92:0] router_001_src_data;                                                                // router_001:src_data -> nios2_qsys_0_instruction_master_limiter:cmd_sink_data
	...
	wire  [92:0] nios2_qsys_0_instruction_master_limiter_cmd_src_data;                               // nios2_qsys_0_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [92:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> nios2_qsys_0_instruction_master_limiter:rsp_sink_data
	...
	wire  [92:0] nios2_qsys_0_instruction_master_limiter_rsp_src_data;                               // nios2_qsys_0_instruction_master_limiter:rsp_src_data -> nios2_qsys_0_instruction_master_agent:rp_data
	...
	wire  [92:0] cmd_demux_001_src2_data;                                                            // cmd_demux_001:src2_data -> cmd_mux_006:sink1_data
	...
	wire  [92:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> rsp_mux_001:sink2_data
	...
	wire   [6:0] nios2_qsys_0_data_master_limiter_cmd_valid_data;                                    // nios2_qsys_0_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	wire         onchip_rom_s1_agent_rdata_fifo_src_valid;                                           // onchip_rom_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] onchip_rom_s1_agent_rdata_fifo_src_data;                                            // onchip_rom_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         onchip_rom_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_006:in_0_ready -> onchip_rom_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> onchip_rom_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> onchip_rom_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                  // onchip_rom_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> onchip_rom_s1_agent:rdata_fifo_sink_error
	...
	Qsys_system_mm_interconnect_0_router_004 router_008 (
	...
	Qsys_system_mm_interconnect_0_cmd_mux_002 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Qsys_system_mm_interconnect_0_rsp_demux_002 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
